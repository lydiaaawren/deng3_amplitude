...
def unzip_json_files(zip_file_path, output_dir="data"):
    """
    ...
    print(f'{str(extracted_count)} JSONs unzipped successfully ! Find them here: {output_dir}')
